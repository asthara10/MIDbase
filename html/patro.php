<?php
	...
	if ($_SESSION['username']) { ?>
		...
		<ul class="navbar-nav">
		  <li class="nav-item">
		   <a class="nav-item nav-link" href="MIOD.php">Home</a>
		  </li>
		  <li class="nav-item">
		    <a class="nav-item nav-link" href="ad_search.php">Advanced Search</a>
		  </li>  
		  <li class="nav-item">
		    <a<a class="nav-item nav-link" href="MIODform.php">Introduce Data<span class="sr-only">(current)</span></a>
		  </li> 
		  <li class="nav-item">
		...
		<button onclick="logout.php" style="width:auto;" class="button">Log Out</button>
